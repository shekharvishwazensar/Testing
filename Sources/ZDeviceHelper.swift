...
public enum Device {
    ...
    /// Device is an [Apple Watch SeriesSE](https://support.apple.com/kb/SP827)
    case appleWatchSeriesSE_40mm
    /// Device is an [Apple Watch SeriesSE](https://support.apple.com/kb/SP827)
    case appleWatchSeriesSE_44mm
    ...
    public static func mapToDevice(identifier: String) -> Device {
        ...
        case "Watch5,9", "Watch5,11": return appleWatchSeriesSE_40mm
        case "Watch5,10", "Watch5,12": return appleWatchSeriesSE_44mm
        case "Watch6,1", "Watch6,3": return appleWatchSeries6_40mm
        case "Watch6,2", "Watch6,4": return appleWatchSeries6_44mm
        case "Watch6,6", "Watch6,8": return appleWatchSeries7_40mm
    ...
    public var diagonal: Double {
        ...
        case .appleWatchSeriesSE_40mm: return 1.8
        case .appleWatchSeriesSE_44mm: return 2.0
    ...
    public var screenRatio: (width: Double, height: Double) {
        ...
        case .appleWatchSeriesSE_40mm: return (width: 4, height: 5)
        case .appleWatchSeriesSE_44mm: return (width: 4, height: 5)
    ...
    public static var allWatches: [Device] {
        return [.appleWatchSeries0_38mm, .appleWatchSeries0_42mm, .appleWatchSeries1_38mm, .appleWatchSeries1_42mm, .appleWatchSeries2_38mm, .appleWatchSeries2_42mm, .appleWatchSeries3_38mm, .appleWatchSeries3_42mm, .appleWatchSeries4_40mm, .appleWatchSeries4_44mm, .appleWatchSeries5_40mm, .appleWatchSeries5_44mm,         .appleWatchSeriesSE_40mm, .appleWatchSeriesSE_44mm, .appleWatchSeries6_40mm, .appleWatchSeries6_44mm, .appleWatchSeries7_40mm, .appleWatchSeries7_44mm]
    }
    ...
    public var ppi: Int? {
        ...
        case .appleWatchSeriesSE_40mm: return 326
        case .appleWatchSeriesSE_44mm: return 326
...
extension Device: CustomStringConvertible {
    ...
    public var description: String {
        ...
        case .appleWatchSeriesSE_40mm: return "Apple Watch SE 40mm"
        case .appleWatchSeriesSE_44mm: return "Apple Watch SE 40mm"
        case .appleWatchSeries6_40mm: return "Apple Watch Series 6 40mm"
        case .appleWatchSeries6_44mm: return "Apple Watch Series 6 40mm"
...
extension Device {
    ...
    public var cpuInfo: Dictionary<String, String> {
        ...
        #elseif os(watchOS)
        switch self {
        case .appleWatchSeries0_38mm: return ["S1":"520 MHz Cortex-A7"]
        case .appleWatchSeries0_42mm: return ["S1":"520 MHz Cortex-A7"]
        case .appleWatchSeries1_38mm: return ["S1P":"Dual‑core 520 MHz"]
        case .appleWatchSeries1_42mm: return ["S1P":"Dual‑core 520 MHz"]
        case .appleWatchSeries2_38mm: return ["S2":"Dual-core 780 MHz Cortex-A7"]
        case .appleWatchSeries2_42mm: return ["S2":"Dual-core 780 MHz Cortex-A7"]
        case .appleWatchSeries3_38mm: return ["S3":"Dual‑core"]
        case .appleWatchSeries3_42mm: return ["S3":"Dual‑core"]
        case .appleWatchSeries4_40mm: return ["S4":"64-bit Dual‑core"]
        case .appleWatchSeries4_44mm: return ["S4":"64-bit Dual‑core"]
        case .appleWatchSeries5_40mm: return ["S5":"64-bit Dual‑core"]
        case .appleWatchSeries5_44mm: return ["S5":"64-bit Dual‑core"]
        case .appleWatchSeriesSE_40mm: return ["S5":"64-bit Dual-core"]
        case .appleWatchSeriesSE_44mm: return ["S5":"64-bit Dual-core"]
        case .appleWatchSeries6_40mm: return ["S6":"64-bit Dual-core"]
        case .appleWatchSeries6_44mm: return ["S6":"64-bit Dual-core"]
        case .appleWatchSeries7_40mm: return ["S7":"64-bit Dual-core"]
        case .appleWatchSeries7_44mm: return ["S7":"64-bit Dual-core"]
        case .simulator(let model): return ["SIMULATOR_MODEL_IDENTIFIER": "\(model)"]
        case .unknown(let identifier): return ["\(identifier)": "Unknown"]
        }
        #elseif os(tvOS)
